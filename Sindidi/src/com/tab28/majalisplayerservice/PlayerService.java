...
public class PlayerService extends Service implements OnCompletionListener,
	...
	public void onCreate() {
		...
		utils = new Utilities();
		songsListingSD = SindidiActivity.songsList;
		songCurrentDurationLabel = new WeakReference<TextView>(
				SindidiActivity.songCurrentDurationLabel);
		super.onCreate();
 ...
 */
	 ...
	 */
	private void initUI() {
		songTitleLabel = new WeakReference<TextView>(SindidiActivity.songTitle);
		songCurrentDurationLabel = new WeakReference<TextView>(
				SindidiActivity.songCurrentDurationLabel);
		songTotalDurationLabel = new WeakReference<TextView>(
				SindidiActivity.songTotalDurationLabel);

		btnPlay = new WeakReference<ImageView>(SindidiActivity.btnPlay);
		btnForward = new WeakReference<ImageView>(SindidiActivity.btnForward);
		btnBackward = new WeakReference<ImageView>(SindidiActivity.btnBackward);
		btnNext = new WeakReference<ImageView>(SindidiActivity.btnNext);
		btnPrevious = new WeakReference<ImageView>(SindidiActivity.btnPrevious);
		btnRepeat = new WeakReference<ImageButton>(SindidiActivity.btnRepeat);
		btnShuffle = new WeakReference<ImageButton>(SindidiActivity.btnShuffle);
		...
		songProgressBar = new WeakReference<SeekBar>(
				SindidiActivity.songProgressBar);
	...
	public void playSong(int songIndex) {
		...
		try {
			...
			if (!songTitle.equals("Sindidi Magal Touba 2012(Ahlul Minan).mp3"))
				mp.setDataSource(songsListingSD.get(songIndex).get("songPath"));
			else {
				mp.setDataSource(
						getApplicationContext(),
						Uri.parse("android.resource://com.tab28.majalisplayerservice/raw/"
								+ R.raw.sindidi));
			}
			mp.setVolume(1f, 1f);
			mp.prepare();
	...
	private void initNotification(int songIndex) {
		...
		Intent notificationIntent = new Intent(this, SindidiActivity.class);
